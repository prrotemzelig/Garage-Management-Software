...
class TasksComponent extends React.Component {
    ...
    render() {
        return (
            <CardComponent containerStyles={this.props.containerStyles} title="משימות" link="ראה הכל" subtitle="היום"
                items={[
                    <Row horizontal="space-between" vertical="center">
                        <span className={css(styles.itemTitle, styles.greyTitle)}>יצירת משימה חדשה</span>
