...
export default (props) => (
 ...
 <svg width="25" height="25" viewBox="0 0 16 16" className="bi bi-columns-gap" fill={props.fill || "#9FA2B4"} xmlns="http://www.w3.org/2000/svg">
...
//rotem changes!! fillRule - fill_rule
//rotem changes!! className - class
);
